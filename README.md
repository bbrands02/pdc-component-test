...
[![Automated Testing](https://github.com/bbrands02/pdc-component-test/actions/workflows/tests.yml/badge.svg)](https://github.com/bbrands02/pdc-component-test/actions/workflows/tests.yml)
...
- [API Documentation (redocly is a API documentation generator)](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/bbrands02/pdc-component-test/main/OAS.yaml&nocors)
- [API Definition (yaml or json file)](https://github.com/bbrands02/pdc-component-test/blob/main/OAS.yaml)
- [Public Code (file about this API and makes it searchable)](https://github.com/bbrands02/pdc-component-test/blob/main/publiccode.yaml)
...
To use this repository as a template, you will need a [GitHub account](https://github.com/login). Make sure you have a GitHub account and are logged in on GitHub. When you are logged in you can [use this template](https://github.com/bbrands02/pdc-component-testAPI/generate), select the owner and fill in a nice name for your new repository. After creating your new repository, please follow these steps:
...
- Execute the command `git clone (link you copied) (directory you want to clone the repository to`, an example: `git clone https://github.com/bbrands02/pdc-component-testAPI.git C:\Users\JohnDoe\Projects`.
...
```bash
git clone https://github.com/bbrands02/pdc-component-testAPI.git
cd PetStoreAPI
docker-compose up
```
...
`https://raw.githubusercontent.com/bbrands02/pdc-component-testAPI/main/publiccode.yaml`
